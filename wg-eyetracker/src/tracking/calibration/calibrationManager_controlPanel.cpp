...
void calibrationManager::setupControlPanel(){
	...
	panel.setup("calibration", 500, 200, 270, 500);
	...
	panel.addSlider("RawDataOffsetX", "RAW_OFFSET_X", ofGetWindowWidth()/2, 0, ofGetWindowWidth()*2, true);
	panel.addSlider("RawDataOffsetY", "RAW_OFFSET_Y", ofGetWindowHeight()/2, 0, ofGetWindowHeight()*2, true);
