...
//--------------------------------------------------------------
void calibrationManager::setup(float pageW, float pageH, float x, float y, float scale){
	...
	calibrationRectangle.width = pageW;
	calibrationRectangle.height = pageH;
...
void calibrationManager::update(){
	...
	calibrationRectangle.x = 0;
	calibrationRectangle.y = 0;
	calibrationRectangle.width = pageWidth; // ofGetWindowWidth();
	calibrationRectangle.height = pageHeight; //ofGetWindowHeight();

	float widthPad = ofGetWindowWidth() * 0.025f;
	float heightPad = ofGetWindowHeight() * 0.025f;
...
void calibrationManager::draw(){
	...
	//ofRect(pageX, pageY, pageW * pageScale, pageH * pageScale);
