...
class eyeTracker{
	...
	public:
		...
		void rotate(bool bCW, bool bCCW);
		...
		ofxCvGrayscaleAdvanced	grayImgFace;
		ofxCvGrayscaleImage		pGrayImgFace;
		ofPoint						faceEdgeMaskStartPos;
		float							faceEdgeMaskInnerRadius;			// < innerRadius = white
		float							faceEdgeMaskOuterRadius;			// > inner radius and < outer radius = fade to black
		unsigned char				* faceEdgeMaskPixels;				// > outer radius = black.....
		ofxCvGrayscaleImage		faceEdgeMask;
		ofxCvGrayscaleImage		faceMotion;
		unsigned char				* faceMotionPixels;	
